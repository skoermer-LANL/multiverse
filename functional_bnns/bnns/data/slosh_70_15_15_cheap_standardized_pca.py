...
try:
    ...
    U_truncated = torch.load(
        os.path.join(data_folder, "slosh_cheap_standardized_U_truncated.pt")
    )
    s_truncated = torch.load(
        os.path.join(data_folder, "slosh_cheap_standardized_s_truncated.pt")
    )
    V_truncated = torch.load(
        os.path.join(data_folder, "slosh_cheap_standardized_V_truncated.pt")
    )
