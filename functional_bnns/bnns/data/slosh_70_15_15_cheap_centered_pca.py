...
try:
    ...
    U_truncated = torch.load(os.path.join( PATH, "slosh_cheap_centered_U_truncated.pt"))
    s_truncated = torch.load(os.path.join( PATH, "slosh_cheap_centered_s_truncated.pt"))
    V_truncated = torch.load(os.path.join( PATH, "slosh_cheap_centered_V_truncated.pt"))
    r = len(s_truncated)    # ~~~ 9
except:
    #
    ...
    torch.save( U_truncated, os.path.join( PATH, "slosh_cheap_centered_U_truncated.pt" ))
    torch.save( s_truncated, os.path.join( PATH, "slosh_cheap_centered_s_truncated.pt" ))
    torch.save( V_truncated, os.path.join( PATH, "slosh_cheap_centered_V_truncated.pt" ))
